/*
 * Timer1 driver, implementation (DS39605F §12.0, Register 12-1).
 */

#include "peripherals/pic18f1320_timer1.h"
#include "core/pic18_irq.h"

/* T1CON prescaler ratios, DS39605F Register 12-1:
...
{
    /* With RD16 set, reading TMR1L latches TMR1H into a shadow (DS39605F
...
{
    /* With RD16 set, writing TMR1L latches TMR1H (DS39605F §12.0); write
...
/**
 * @brief  Map a Timer1 prescaler enum to its ratio (DS39605F Register
