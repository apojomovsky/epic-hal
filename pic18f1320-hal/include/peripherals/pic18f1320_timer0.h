 ...
 * prescaler (DS39605F §10.0). PIC18's Timer0 is controlled by the
...
#ifndef PIC18F1320_TIMER0_H
#define PIC18F1320_TIMER0_H

#include "pic18f1320.h"
#include "pic18f1320_sfr.h"

/**
 * @brief Timer0 counter width (T0CON<T08BIT>, DS39605F Register 10-1).
...
/**
 * @brief Timer0 clock source (T0CON<T0CS>, DS39605F §10.0, Reg 10-1).
 */
typedef enum {
...
/**
 * @brief Timer0 external-clock edge (T0CON<T0SE>, DS39605F §10.0).
 ...
 *        T0CON<T0PS2:T0PS0> (DS39605F Table 10-1).
 *
