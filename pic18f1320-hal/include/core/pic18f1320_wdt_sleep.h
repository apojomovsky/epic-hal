 ...
 * `pic14_wdt_sleep.h`'s API (DS39605F §4.0/§9.0/§14.x/§3.0); PIC18
...
#ifndef PIC18F1320_WDT_SLEEP_H
#define PIC18F1320_WDT_SLEEP_H
 ...
 *         period (DS39605F §14.x). On the host simulator it's a no-op.
 */
 ...
 *         interrupt wakes it (DS39605F §3.0).
 *
 ...
 *         Set on Power-on Reset (DS39605F Register 4-1).
