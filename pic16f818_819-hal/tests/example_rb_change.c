 ...
 * (EPIC_GPIO_RegisterChangeCallback / RB_IRQHandler) on the sim. RB4 to
 * RB7 are the interrupt-on-change pins (DS39598F Table 1-2). The host
 * sim does not model RBIF-on-mismatch, so the test asserts RBIF
