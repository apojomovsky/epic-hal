/*
 * Host tests for epic_math_diff3 and epic_math_integrate_simpson38
...
static void test_diff3_linear(void)
{
    ...
    for (size_t i = 0; i < sizeof(m)/sizeof(m[0]); i++) {
        ...
        int16_t got = epic_math_diff3(x0, (int16_t)m[i], x2, INV_2H_Q8);
...
static void test_diff3_quadratic(void)
{
    ...
    for (int x = 0; x <= 60; x++) {
        ...
        int16_t got = epic_math_diff3(xm1, (int16_t)(x * x), xp1, INV_2H_Q8);
...
static void test_diff3_cubic_bound(void)
{
    ...
    for (int x = 0; x <= 20; x++) {
        ...
        int16_t got = epic_math_diff3(xm1, (int16_t)(x * x * x), xp1, INV_2H_Q8);
...
static void test_diff3_noninteger_slope(void)
{
    ...
    int16_t got = epic_math_diff3(1, 2, 4, INV_2H_Q8);
...
static void test_simpson38_exact(void)
{
    ...
    for (int c = 0; c <= 20; c++) {
        int32_t got = epic_math_integrate_simpson38((int16_t)c, (int16_t)c,
                                                   (int16_t)c, (int16_t)c,
                                                   THREE_H_OVER_8_Q16);
    ...
    {
        int32_t got = epic_math_integrate_simpson38(0, 1, 2, 3, THREE_H_OVER_8_Q16);
        int32_t exp = (int32_t)(4.5 * 65536.0);
        CHECK(got == exp, "simpson38 linear");
    }
    /* f(x)=x^3, [0,3]: integral = 20.25. f0=0,f1=1,f2=8,f3=27. */
    {
        int32_t got = epic_math_integrate_simpson38(0, 1, 8, 27, THREE_H_OVER_8_Q16);
...
static void test_simpson38_quartic_bound(void)
{
    ...
    int32_t got = epic_math_integrate_simpson38(0, 1, 16, 81, THREE_H_OVER_8_Q16);
