 ...
 * b@2, r@4, co@6. */
uint16_t epic_math_add_u16(uint16_t a, uint16_t b, bool *carry_out) __at(0x170)
{
...
uint16_t epic_math_sub_u16(uint16_t a, uint16_t b, bool *borrow_out) __at(0x1C0)
{
    pic16_mscratch[0] = (uint8_t)a;           pic16_mscratch[1] = (uint8_t)(a >> 8);
    pic16_mscratch[2] = (uint8_t)b;           pic16_mscratch[3] = (uint8_t)(b >> 8);
    pic16_mscratch[6] = 0u;
...
int16_t epic_math_negate_s16(int16_t v) __at(0x140)
{
...
int32_t epic_math_negate_s32(int32_t v) __at(0x490)
{
