...
(`swuart_test_fire_tx_event`, `swuart_test_fire_rx_event[_b]`,
`swuart_test_set_capture`, `swuart_test_last_tx_mode`,
`swuart_test_last_tx_compare`), gated behind `EPIC_SWUART_TEST_HOOKS`,
