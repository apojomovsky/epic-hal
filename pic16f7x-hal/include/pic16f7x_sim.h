/* Public API for the PIC16F7X host simulation backend: drive input
 * pins, read output-pin levels, advance time via pic16f7x_sim_step(),
 * and inject peripheral events. SFRs index the host-side register file
 * (include/host/pic16f7x_platform.h); see src/sim/pic16f7x_sim.c
 * for the peripheral models. */

#ifndef PIC16F7X_SIM_H
#define PIC16F7X_SIM_H
 ...
 *        the last value driven via @ref pic16f7x_sim_drive_input.
 * @param port One of 'A'..'E'.
 * @param pin Pin number 0..7.
 ...
 */
typedef void (*pic16f7x_sim_irq_cb_t)(void);
