 ...
 * target/pic16f7x_platform.h and host/pic16f7x_platform.h); the build's
 * include path picks which resolves, so pic16f7x.h includes
 * "pic16f7x_platform.h" unconditionally with no #ifdef.
 *
