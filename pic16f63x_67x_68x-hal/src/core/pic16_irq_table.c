/* PIC16F63x/67x/68x IRQ translation table (16F631, DS40001262F
 * §14.0). PORTA/B change, INT and TMR0 live in INTCON; TMR1 in PIR1;
 * EEPROM, C1, C2 and OSF in PIR2. Consumed by the shared
