 ...
 * shape on this ticket: the 20-pin 16F631 only (1024 W flash, 64 B
 * SRAM, 128 B EEPROM, 18 I/O on PORTA/B/C, dual comparators, Timer0 +
 * Timer1 with gate, no ADC/USART/SSP/CCP/Timer2; DS40001262F Table 1).
 * The 14-pin shapes (630/676/684/688) and the 20-pin siblings
 * (639/677/685/689) join in epic-hal#152 under capability macros, so
 * this header selects exactly one device the same way the 628A
 * umbrella does. */
...
#if !defined(PIC16F631)
#define PIC16F631   1
#endif

#if defined(PIC16F631) > 1
#error "Define exactly one of PIC16F631."
#endif
