/* Public API for the PIC16F83/84/84A host simulation backend: drive
 * input pins, read output-pin levels, advance time via
 * pic16f83_84_sim_step(), and inject EEPROM events. SFRs index the
 * host-side register file (include/host/pic16f83_84_platform.h); see
 * src/sim/pic16f83_84_sim.c for the peripheral models. */

#ifndef PIC16F83_84_SIM_H
#define PIC16F83_84_SIM_H
 ...
 */
typedef void (*pic16f83_84_sim_irq_cb_t)(void);
 ...
 *        same address return it. The part has 64 bytes; the rest of
 *        the 256-byte table is ignored.
 * @param addr the EEPROM address, 0..63.
