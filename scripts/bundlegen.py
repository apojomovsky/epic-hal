...
def emit_quickstart_md(manifest, family_name: str, version: str) -> str:
    ...
    return "\n".join([
        ...
        "",
        "XC8 also needs this family's device pack installed next to it",
        ...
        "# The -Wno-* list silences library-and-small-app noise (never-called",
        "# HAL APIs, NULL-callback seams, non-reentrant duplication); 1393",
        "# (hardware stack overflow) is deliberately not silenced.",
