...
stray_files_check() {
    ...
    local dir_whitelist='^epic-[a-z0-9-]+$|^pic16f87xa-hal$|^pic18fxx5x-hal$|^pic16f193x-hal$|^pic16f88x-hal$|^pic16f628a-hal$|^pic16f83_84-hal$|^pic16f63x_67x_68x-hal$|^pic18f1320-hal$|^pic18f2520-hal$|^pic16f7x-hal$|^pic[0-9a-z]+-midrange-core$|^pic[0-9a-z]+-enhanced-core$|^pic-baseline-core$|^pic18-core$|^docs$|^scripts$|^docker$|^examples$|^tests$|^\.github$'
    local bad=0
    local f
