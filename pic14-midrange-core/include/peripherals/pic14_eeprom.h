/* Shared PIC14 mid-range Data EEPROM driver (87XA + 88X). Sources:
 * DS39582B §3 (87XA) and DS40001291H §10 (88X); § numbers below are
 * the 87XA ones. Full register reference: the family MANUAL.md. The
 * driver hides the mandatory 0x55/0xAA unlock sequence; writes are
 * non-blocking, poll EEIF (PIR2<4>) or use the callback for completion. */

#ifndef PIC14_EEPROM_H
#define PIC14_EEPROM_H
 ...
 *
 *         Per §3.5 (§10.4 on 88X): EEADR must be loaded first, then RD.
