/* Shared PIC14 mid-range comparator driver (87XA single-CMCON parts;
 * the 88X dual-comparator block keeps its own driver: different
 * hardware). Sources: DS39582B §12 (87XA); the 628A comparator section
 * is cited in MANUAL.md when its shim lands. Inputs multiplex onto
 * PORTA; outputs on RA4/RA5 when enabled. The 8 operating modes are on
 * COMP_ModeTypeDef below. */
