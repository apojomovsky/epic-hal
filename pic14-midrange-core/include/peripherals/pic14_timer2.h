/* Shared PIC14 mid-range Timer2 driver (87XA + 88X), 8-bit timer with
 * PR2 period register and postscaler. Sources: DS39582B §7 (87XA) and
 * DS40001291H §7 (88X); full reference: the family MANUAL.md. TMR2
 * resets to 0 on TMR2==PR2 (never reaches PR2+1); TMR2IF fires every
 * prescaler x postscaler x (PR2+1) cycles and drives the CCP PWM base. */

#ifndef PIC14_TIMER2_H
#define PIC14_TIMER2_H
