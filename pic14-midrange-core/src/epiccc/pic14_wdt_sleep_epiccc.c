/* Shared PIC14 mid-range epic-cc implementation of EPIC_WDT_Refresh /
 * EPIC_Sleep_Enter. Uses the intrinsics from <epic-cc.h> (which lower
 * to opaque asm blocks the compiler understands). The XC8 target uses
