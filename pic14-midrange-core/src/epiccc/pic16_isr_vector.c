 ...
 * (DS39582B §14.11, DS40001291H §14.11) delegates to the shared
 * dispatcher. The XC8 target uses its interrupt attribute plus inline
 * asm to normalize the bank; epic-cc uses __attribute__((interrupt(0)))
 * and its banking pass handles the rest. */
