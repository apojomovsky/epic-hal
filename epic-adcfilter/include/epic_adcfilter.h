/**
 * @file    epic_adcfilter.h
 * @brief   Vendor-agnostic ADC oversampling and moving-average filter.
 *          Zero dependencies beyond <stdint.h>.
 *
 * @details
 *   `epic_adcfilter_oversample`: oversample-and-decimate (average 4^n raw
 *   samples, right-shift by n) for n extra bits of resolution.
 *   `epic_adcfilter_avg_push`: an O(1) moving average over a caller-owned
 *   ring buffer. Both take a `epic_adcfilter_read_fn` callback instead of
