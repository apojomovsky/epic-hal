...
FINAL_IMAGE=${DISTDIR}/epic-hal-demo-pic16f193x.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
# Source Files
SOURCEFILES=../../epic-common/src/core/epic_harness_target.c ../../pic16f193x-hal/src/core/pic16f193x_irq.c ../../pic16f193x-hal/src/core/pic16f193x_irq_dispatch.c ../../pic16f193x-hal/src/target/pic16f193x_isr_vector.c ../../pic16f193x-hal/src/core/pic16f193x_wdt_sleep.c ../../pic16f193x-hal/src/target/pic16f193x_wdt_sleep_target.c ../../pic16f193x-hal/src/peripherals/pic16f193x_adc.c ../../pic16f193x-hal/src/peripherals/pic16f193x_ccp.c ../../pic16f193x-hal/src/peripherals/pic16f193x_comp.c ../../pic16f193x-hal/src/peripherals/pic16f193x_cps.c ../../pic16f193x-hal/src/peripherals/pic16f193x_dac.c ../../pic16f193x-hal/src/peripherals/pic16f193x_eeprom.c ../../pic16f193x-hal/src/peripherals/pic16f193x_fvr.c ../../pic16f193x-hal/src/peripherals/pic16f193x_gpio.c ../../pic16f193x-hal/src/peripherals/pic16f193x_lcd.c ../../pic16f193x-hal/src/peripherals/pic16f193x_srlatch.c ../../pic16f193x-hal/src/peripherals/pic16f193x_ssp.c ../../pic16f193x-hal/src/peripherals/pic16f193x_timer0.c ../../pic16f193x-hal/src/peripherals/pic16f193x_timer1.c ../../pic16f193x-hal/src/peripherals/pic16f193x_timer246.c ../../pic16f193x-hal/src/peripherals/pic16f193x_usart.c main.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/epic-hal-demo-pic16f193x.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/epic-hal-demo-pic16f193x.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${DISTDIR}
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/epic-hal-demo-pic16f193x.X.${IMAGE_TYPE}.map  -D__DEBUG=1  -mdebugger=none  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -O0 -fasmfile -maddrqual=ignore -DPIC16F1937 -xassembler-with-cpp -I"../../pic16f193x-hal/include/target" -I"../../pic16f193x-hal/include" -I"../../epic-common/include" -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -mno-default-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/epic-hal-demo-pic16f193x.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}
	@${RM} ${DISTDIR}/epic-hal-demo-pic16f193x.X.${IMAGE_TYPE}.hex


else
${DISTDIR}/epic-hal-demo-pic16f193x.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${DISTDIR}
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/epic-hal-demo-pic16f193x.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -O0 -fasmfile -maddrqual=ignore -DPIC16F1937 -xassembler-with-cpp -I"../../pic16f193x-hal/include/target" -I"../../pic16f193x-hal/include" -I"../../epic-common/include" -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -mno-default-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/epic-hal-demo-pic16f193x.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}
