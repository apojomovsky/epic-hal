/* Data EEPROM driver. Source: DS40001291H §10.0; full register reference:
 * MANUAL.md §EEPROM. The driver hides the mandatory 0x55/0xAA unlock
 * sequence; writes are non-blocking, poll EEIF (PIR2<4>) or use the
 * callback for completion. */

#ifndef PIC16F88X_EEPROM_H
#define PIC16F88X_EEPROM_H
 ...
 *
 *         Per §10.4: EEADR must be loaded first, then RD.
