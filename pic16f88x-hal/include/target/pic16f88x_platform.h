 ...
 * host/pic16f88x_platform.h); the include path picks which resolves,
...
/* Same fix, Banks 2/3. The 88X spreads SFRs across all four banks:
 * Bank 2 holds WDTCON/CM1CON0/CM2CON0/CM2CON1 and the EEPROM
 * data/address registers; Bank 3 holds SRCON/BAUDCTL/ANSEL/ANSELH and
 * EECON1/EECON2. These set/clear BOTH RP1:RP0 explicitly since the
 * peripheral code interleaves banks back to back, so the incoming bank
