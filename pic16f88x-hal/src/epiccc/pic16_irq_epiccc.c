 ...
 * INTCON / PIE1 / PIE2 (DS40001291H §14.11 + Figure 14-10); the
...
void EPIC_IRQ_DisableSrc(PIC16_IRQn irq)
{
     ...
     * comment (target/pic16f88x_platform.h) for the full account. */
...
{
    /* PIC16F88X has a single interrupt vector, no priority scheme
     * (DS40001291H §14.11). This is the no-op half of the shared
