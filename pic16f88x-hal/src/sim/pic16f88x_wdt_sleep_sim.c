 ...
 * The BOR/POR/WDT-software helpers live in the shared
 ...
 *        callers should keep driving pic16f88x_sim_step() to advance
 *        time.
 */
void EPIC_Sleep_Enter(void)
{
    /* No-op: the sim does not stop execution. Callers should keep driving
     * pic16f88x_sim_step() to advance time. */
}
