 ...
 * `pic14_wdt_sleep.h`'s API (DS39609B §4.0/§9.0/§14.x/§3.0); PIC18
...
#ifndef PIC18F6520_WDT_SLEEP_H
#define PIC18F6520_WDT_SLEEP_H
 ...
 *         period (DS39609B §14.x). On the host simulator it's a no-op.
 */
 ...
 *         interrupt wakes it (DS39609B §3.0).
 *
 ...
 *         Set on Power-on Reset (DS39609B Register 4-1).
