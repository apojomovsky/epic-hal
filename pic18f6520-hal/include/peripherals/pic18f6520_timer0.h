 ...
 * prescaler (DS39609B §11.0). PIC18's Timer0 is controlled by the
...
#ifndef PIC18F6520_TIMER0_H
#define PIC18F6520_TIMER0_H

#include "pic18f6520_hal.h"
#include "pic18f6520_sfr.h"

/**
 * @brief Timer0 counter width (T0CON<T08BIT>, DS39609B Register 11-1).
...
/**
 * @brief Timer0 clock source (T0CON<T0CS>, DS39609B §11.0, Reg 11-1).
 */
typedef enum {
...
/**
 * @brief Timer0 external-clock edge (T0CON<T0SE>, DS39609B §11.0).
 ...
 *        T0CON<T0PS2:T0PS0> (DS39609B Table 11-1).
 *
