 ...
 * (DS39609B §13.0). Simpler than PIC16's because PIC18 puts PR2 in the
...
#ifndef PIC18F6520_TIMER2_H
#define PIC18F6520_TIMER2_H

#include "pic18f6520_hal.h"
#include "pic18f6520_sfr.h"

/**
 * @brief Prescaler ratio (T2CON<T2CKPS1:T2CKPS0>, DS39609B Register 13-1).
 */
typedef enum {
...
/**
 * @brief Postscaler ratio (T2CON<T2OUTPS3:T2OUTPS0>, DS39609B Register 13-1).
