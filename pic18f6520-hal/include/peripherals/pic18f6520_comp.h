/*
 * Two on-chip comparators (DS39609B §20.0), 8 modes selected by
 * CMCON<CM2:CM0> (Figure 20-1). Same bit layout as the 4550/2520, in
 * the Access Bank (0xFB4, no bank switching); the comparator voltage
 * reference (CVRCON, Register 21-1) is a separate module.
 */

#ifndef PIC18F6520_COMP_H
#define PIC18F6520_COMP_H

#include "pic18f6520_hal.h"
#include "pic18f6520_sfr.h"

/**
 * @brief Comparator operating mode (CMCON<CM2:CM0>, DS39609B Figure 20-1).
 *        Same eight modes as the 4550/2520 comparators.
 */
typedef enum {
...
/**
 * @brief  Disable the comparators (CMCON = 0x00, POR reset mode) and
 *         clear CMIF.
 * @return EPIC_OK.
 */
