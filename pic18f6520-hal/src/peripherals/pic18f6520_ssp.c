/*
 * MSSP driver, implementation (DS39609B §17.0). Register-level: the I2C
...
/**
 * @brief  Read a byte from SSPBUF; reading clears BF (DS39609B
 *         Register 19-1).
 * @return The received byte.
 */
uint8_t EPIC_SSP_ReadByte(void)
{
    /* Reading SSPBUF clears BF (DS39609B Register 19-1). */
