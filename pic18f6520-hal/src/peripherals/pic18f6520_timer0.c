/*
 * Timer0 driver, implementation (DS39609B §11.0, Register 11-1).
 */

#include "peripherals/pic18f6520_timer0.h"
#include "core/pic18_irq.h"

/* Prescaler ratios, DS39609B Table 11-1.
...
EPIC_StatusTypeDef EPIC_TIMER0_Start(const TIMER0_HandleTypeDef *h)
{
     ...
     * TMR0H is the high byte (DS39609B §11.0). */
...
{
    /* Reading TMR0L latches TMR0H on real hardware (DS39609B §11.0); the
...
/**
 * @brief  Map a Timer0 prescaler enum to its ratio (DS39609B Table 11-1).
