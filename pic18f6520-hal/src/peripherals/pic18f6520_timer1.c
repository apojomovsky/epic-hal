/*
 * Timer1 driver, implementation (DS39609B §12.0, Register 12-1).
 */

#include "peripherals/pic18f6520_timer1.h"
#include "core/pic18_irq.h"

/* T1CON prescaler ratios, DS39609B Register 12-1:
...
{
    /* With RD16 set, reading TMR1L latches TMR1H into a shadow (DS39609B
...
{
    /* With RD16 set, writing TMR1L latches TMR1H (DS39609B §12.0); write
...
/**
 * @brief  Map a Timer1 prescaler enum to its ratio (DS39609B Register
...
EPIC_StatusTypeDef EPIC_TIMER1_Start(const TIMER1_HandleTypeDef *h)
{
    ...
    /* Program T1CON in one write. RD16 stays set (from Init); bit 6 is
     * unimplemented on this part (no T1RUN, DS39609B Register 12-1).
