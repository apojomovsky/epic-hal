/*
 * PIC18F6520 host-simulation implementation of the test harness
 ...
 * this file is PIC18F6520-specific only because it pumps the PIC18F6520
 * simulator.
 */
...
/**
 * @brief  Freeze the run. No-op on the host: the example falls through to
 *         `return rc` and the process exits normally.
 */
void pic18f6520_harness_halt(void)
{
}
