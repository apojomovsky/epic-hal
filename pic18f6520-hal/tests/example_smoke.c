 ...
 * against an empty PIC18F6520 family backend (no GPIO, Timer0, or
 ...
 *
 *          Runs SIM_CYCLES ticks against an empty PIC18F6520 family
...
int main(void)
{
    ...
    epic_harness_log("smoke: %u ticks, device %s\n",
                     (unsigned)ticks, PIC18F6520_DEVICE_NAME);
