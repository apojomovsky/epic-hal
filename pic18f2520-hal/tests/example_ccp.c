/*
 * CCP compare smoke: program CCP1 in compare mode against Timer1,
...
/**
 * @brief  Program CCP1 compare mode + verify registers, run Timer1.
 *
...
int main(void)
{
    ...
    ch.AutoShutdown.AutoRestart = false;
