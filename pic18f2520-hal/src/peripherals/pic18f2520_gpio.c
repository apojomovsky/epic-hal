/*
 * GPIO driver, implementation (DS39631E §10.0). PIC18 exposes the output
 ...
 * in INTCON2<RBPU>. The 28-pin 2520 has only PORTA/B/C; the lone RE3/MCLR
 * input has no LAT/TRIS registers.
 */
 ...
 *         mandatory (DS39631E §9.0): the mismatch comparator latches the
...
void RB_IRQHandler(void)
{
    ...
    /* MUST read PORTB before clearing RBIF (DS39631E §9.0): the mismatch
