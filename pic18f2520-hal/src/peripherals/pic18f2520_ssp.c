/*
 * MSSP driver, implementation (DS39631E §17.0). Register-level: the I2C
...
#include "peripherals/pic18f2520_ssp.h"
...
/**
 * @brief  Read a byte from SSPBUF; reading clears BF (DS39631E
 *         Register 19-1).
 * @return The received byte.
 */
uint8_t EPIC_SSP_ReadByte(void)
{
    /* Reading SSPBUF clears BF (DS39631E Register 19-1). */
