/*
 * Timer3 driver, implementation (DS39631E §12.0, Register 12-1).
 */

#include "peripherals/pic18f2520_timer3.h"
#include "core/pic18_irq.h"

/* T3CON prescaler ratios, DS39631E Register 12-1:
...
{
    /* With RD16 set, reading TMR3L latches TMR3H into a shadow (DS39631E
...
{
    /* With RD16 set, writing TMR3L latches TMR3H (DS39631E §12.0); write
...
/**
 * @brief  Map a Timer3 prescaler enum to its ratio (DS39631E Register
