/*
 * Timer0 driver, implementation (DS39631E §11.0, Register 11-1).
 */

#include "peripherals/pic18f2520_timer0.h"
#include "core/pic18_irq.h"

/* Prescaler ratios, DS39631E Table 11-1.
...
{
    /* Reading TMR0L latches TMR0H on real hardware (DS39631E §11.0); the
...
/**
 * @brief  Map a Timer0 prescaler enum to its ratio (DS39631E Table 11-1).
