/*
 * Timer1 driver, implementation (DS39631E §12.0, Register 12-1).
 */

#include "peripherals/pic18f2520_timer1.h"
#include "core/pic18_irq.h"

/* T1CON prescaler ratios, DS39631E Register 12-1:
...
{
    /* With RD16 set, reading TMR1L latches TMR1H into a shadow (DS39631E
...
{
    /* With RD16 set, writing TMR1L latches TMR1H (DS39631E §12.0); write
...
/**
 * @brief  Map a Timer1 prescaler enum to its ratio (DS39631E Register
