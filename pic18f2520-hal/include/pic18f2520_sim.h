 ...
 *        power-on-reset value (DS39631E Table 5-1). Must be called before
 *        any HAL call.
 */
 ...
 *        returns the latched value in LATx (DS39631E §10.0). For inputs,
 *        this returns the last value driven via @ref pic18_sim_drive_input.
 * @param port the port letter, 'A'..'C'.
