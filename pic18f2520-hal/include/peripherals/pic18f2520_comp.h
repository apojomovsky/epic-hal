/*
 * Two on-chip comparators (DS39631E §20.0), 8 modes selected by
 * CMCON<CM2:CM0> (Figure 20-1). Same bit layout as the PIC16 comparator,
 * in the Access Bank (0xFB4, no bank switching); the comparator voltage
 * reference (CVRCON) is a separate module.
 */

#ifndef PIC18F2520_COMP_H
#define PIC18F2520_COMP_H

#include "pic18f2520_hal.h"
#include "pic18f2520_sfr.h"

/**
 * @brief Comparator operating mode (CMCON<CM2:CM0>, DS39631E Figure 20-1).
