/*
 * Timer1 driver, 16-bit timer/counter (DS39631E §12.0). PIC18's T1CON
...
#ifndef PIC18F2520_TIMER1_H
#define PIC18F2520_TIMER1_H

#include "pic18f2520_hal.h"
#include "pic18f2520_sfr.h"

/**
 * @brief Timer1 clock source (T1CON<TMR1CS>, DS39631E Register 12-1).
 */
typedef enum {
...
/**
 * @brief External-clock synchronisation (T1CON<T1SYNC>, DS39631E §12.0).
...
/**
 * @brief T1OSC crystal-oscillator enable (T1CON<T1OSCEN>, DS39631E §12.0).
...
/**
 * @brief Prescaler ratio (T1CON<T1CKPS1:T1CKPS0>, DS39631E Register 12-1).
 */
typedef enum {
