/*
 * 10-bit SAR ADC (DS39631E §19.0), 10 channels on 28-pin parts, 13 on
 ...
 * is the raw 4-bit PCFG code from Table 19-3, not a curated enum.
 */

#ifndef PIC18F2520_ADC_H
#define PIC18F2520_ADC_H
...
/**
 * @brief A/D acquisition time (ADCON2<ACQT2:ACQT0>, Register 19-3).
...
typedef struct {
    ...
    uint8_t                     PinConfig;      /**< PCFG3:PCFG0 (Table 19-3), 0..15. */
