 ...
 * prescaler (DS39631E §11.0). PIC18's Timer0 is controlled by the
...
#ifndef PIC18F2520_TIMER0_H
#define PIC18F2520_TIMER0_H

#include "pic18f2520_hal.h"
#include "pic18f2520_sfr.h"

/**
 * @brief Timer0 counter width (T0CON<T08BIT>, DS39631E Register 11-1).
...
/**
 * @brief Timer0 clock source (T0CON<T0CS>, DS39631E §11.0, Reg 11-1).
 */
typedef enum {
...
/**
 * @brief Timer0 external-clock edge (T0CON<T0SE>, DS39631E §11.0).
 ...
 *        T0CON<T0PS2:T0PS0> (DS39631E Table 11-1).
 *
