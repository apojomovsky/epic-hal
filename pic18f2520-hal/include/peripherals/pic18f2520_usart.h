/*
 * EUSART driver, async + sync master/slave (DS39631E §18.0). PIC18 adds
...
#ifndef PIC18F2520_USART_H
#define PIC18F2520_USART_H

#include "pic18f2520_hal.h"
#include "pic18f2520_sfr.h"

/**
 * @brief USART mode (TXSTA<SYNC>, DS39631E Register 18-1).
 */
typedef enum {
...
/**
 * @brief Synchronous clock source (TXSTA<CSRC>, Register 18-1).
...
/**
 * @brief High/low baud-rate divisor (TXSTA<BRGH>, DS39631E §18.1).
 *        Combined with @ref USART_BaudGenTypeDef per Table 18-1.
 */
typedef enum {
...
/**
 * @brief Baud-generator width (BAUDCON<BRG16>, DS39631E Register 18-3).
...
/**
 * @brief Clear an overrun: clear CREN, then re-set it (DS39631E §18.2.2).
 */
