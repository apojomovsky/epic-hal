/*
 * Timer3 driver, 16-bit timer/counter (DS39631E §12.0), a second
...
#ifndef PIC18F2520_TIMER3_H
#define PIC18F2520_TIMER3_H

#include "pic18f2520_hal.h"
#include "pic18f2520_sfr.h"

/**
 * @brief Timer3 clock source (T3CON<TMR3CS>, DS39631E Register 12-1).
 */
typedef enum {
...
/**
 * @brief External-clock synchronisation (T3CON<T3SYNC>, DS39631E §12.0).
...
/**
 * @brief Prescaler ratio (T3CON<T3CKPS1:T3CKPS0>, DS39631E Register 12-1).
 */
typedef enum {
