/*
 * MSSP driver: SPI master/slave + I2C master/slave (DS39631E §17.0).
...
#ifndef PIC18F2520_SSP_H
#define PIC18F2520_SSP_H

#include "pic18f2520_hal.h"
#include "pic18f2520_sfr.h"

/**
 * @brief SSP mode select (SSPCON1<3:0>, DS39631E Registers 17-2/17-4).
 */
typedef enum {
...
/**
 * @brief SPI clock-edge select (SSPSTAT<CKE>, DS39631E §17.2.1).
 */
typedef enum {
...
/**
 * @brief SPI clock polarity (SSPCON1<CKP>, DS39631E §17.2.4).
 */
typedef enum {
...
/**
 * @brief SPI input-data sample phase (SSPSTAT<SMP>, DS39631E §17.2.4).
 *        Master mode only.
 */
typedef enum {
 ...
 *         DS39631E §17.4.2: Fscl = Fosc / (4 x (SSPADD + 1))
